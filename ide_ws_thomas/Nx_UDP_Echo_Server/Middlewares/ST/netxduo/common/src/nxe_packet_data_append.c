...
UINT  _nx_packet_data_appendth(NX_PACKET *packet_ptr, VOID *data_start, ULONG data_size,
...
UINT status;
    ...
    /* Call actual packet data append function.  */
    status =  _nx_packet_data_appendth(packet_ptr, data_start, data_size, pool_ptr, wait_option);
